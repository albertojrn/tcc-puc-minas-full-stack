...
router.put('/:product_id/:feature_values_id', authTokenCheck, ensureIsAdmin, (req, res, next) => {
  try {
...
router.delete('/:product_id/:feature_values_id', authTokenCheck, ensureIsAdmin, (req, res, next) => {
  try {
    const product_id = req.params.product_id
    const feature_values_id = req.params.feature_values_id
